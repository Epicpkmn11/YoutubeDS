 ...
 * const unsigned char *imageBuffer is the vector to load the raw pixel data into
 ...
 * int w is the Width
 * int h is the Height
 * const unsigned char *imageBuffer is the raw pixel data
 ...
 * const unsigned char *imageBuffer is the raw pixel data
 */
void fillSpriteImage(int id, bool top, const unsigned char *imageBuffer, int size = 32*32);
 ...
 * const unsigned char *imageBuffer is the raw pixel data
 */
void fillSpriteImage(int id, int x, int y, int w, int h, const unsigned char *imageBuffer);
 ...
 * int yOffset is the Y position in the sheet to start at
 */
void fillSpriteFromSheet(int id, bool top, const unsigned char *imageBuffer, int w, int h, int imageWidth, int xOffset, int yOffset);
 ...
 * int yOffset is the Y position in the sheet to start at
 */
void fillSpriteFromSheetScaled(int id, bool top, double scale, const unsigned char *imageBuffer, int w, int h, int imageWidth, int xOffset, int yOffset);
 ...
 * int yOffset is the Y position in the sheet to start at
 */
void fillSpriteFromSheetTinted(int id, bool top, const unsigned char *imageBuffer, u16 color, int w, int h, int imageWidth, int xOffset, int yOffset);
